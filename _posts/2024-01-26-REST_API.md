...
![slide_13](https://github.com/han-tomas/han-tomas.github.io/assets/124488773/745de8e5-60c0-4f5b-b33e-3ebf539f4a81){: width="70%" }   
### REST  
#### WEB (1991)  
> 어떻게 인터넷에서 정보를 공유할 것인가?  

이에 대한 해답으로 **Web**이 출범하고 이를 따른다.  
**정보들을 하이퍼텍스트로 연결한다**  
* 표현 형식 : HTML
* 식별자 : URI  
* 전송 방법 : HTTP   
...
|SOAP|REST|
|:---:|:---:|
|<ul><li>복잡<br> <li>규칙 많음</ul>|<ul><li>간단<br> <li>규칙 적음</ul>|  
...
![images_kjh03160_post_edbf8e1f-7e61-411c-a1aa-744afb19638f_image](https://github.com/han-tomas/han-tomas.github.io/assets/124488773/0aa849a8-711f-46cd-b87c-f1adcce7bc80){: width="70%" } 
...
---  
##REST API에 대한 결론  
1. REST API를 구현하고 REST API라고 부른다.<br> &rarr; 
